...
from src.utils import set_seed, load_config, save_checkpoint, count_parameters
from src.model import build_model
from src.data import load_multitask_dataset, make_collate_fn
...
def quick_eval(model, tokenizer, device, dataset_name, max_samples=100):
    ...
    try:
        from src.evaluate import generate_predictions, compute_metrics
    ...
    for epoch in range(epochs):
        ...
        for step_in_epoch, batch in enumerate(pbar):
            ...
            if (step_in_epoch + 1) % grad_accum_steps == 0:
                ...
                pbar.set_postfix_str(f"loss={running_loss:.4f} lr={current_lr:.2e}")
